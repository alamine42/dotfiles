...
Then use this description to identify whether a task already exists in Beads for this feature. make sure that task description comprehensively encompasses everything what the feature I'm talking about. If there are any gaps, identify them.
